...
class GmapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gmap" do
    assert_difference('Gmap.count') do
      post gmaps_url, params: { gmap: { address: @gmap.address, latitude: @gmap.latitude, longitude: @gmap.longitude } }
    end
  ...
  test "should update gmap" do
    patch gmap_url(@gmap), params: { gmap: { address: @gmap.address, latitude: @gmap.latitude, longitude: @gmap.longitude } }
